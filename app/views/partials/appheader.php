<div id="topbar" class="navbar navbar-expand-md fixed-top navbar-dark" style="background: rgb(19,179,194);
background: -moz-linear-gradient(90deg, rgba(19,179,194,1) 6%, rgba(19,134,194,1) 49%);
background: -webkit-linear-gradient(90deg, rgba(19,179,194,1) 6%, rgba(19,134,194,1) 49%);
background: linear-gradient(90deg, rgba(19,179,194,1) 6%, rgba(19,134,194,1) 49%);
filter: progid:DXImageTransform.Microsoft.gradient(startColorstr="#13b3c2",endColorstr="#1386c2",GradientType=1);">
    <div class="container-fluid">
        ...
        if(user_login_status() == true ){ 
        ?>
        <nav id="sidebar" class="navbar-dark" style="background: rgb(50,210,159);
background: -moz-linear-gradient(161deg, rgba(50,210,159,1) 27%, rgba(15,77,100,1) 80%);
background: -webkit-linear-gradient(161deg, rgba(50,210,159,1) 27%, rgba(15,77,100,1) 80%);
background: linear-gradient(161deg, rgba(50,210,159,1) 27%, rgba(15,77,100,1) 80%);
filter: progid:DXImageTransform.Microsoft.gradient(startColorstr="#32d29f",endColorstr="#0f4d64",GradientType=1);">
